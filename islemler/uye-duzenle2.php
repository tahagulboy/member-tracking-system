...
$uyeDuzenle = "UPDATE Üyeler SET ÜyeTC ='$UyeTC', ÜyeAdı='$UyeAdı', ÜyeSoyadı='$UyeSoyadı', 
BabaAdı='$BabaAdi', AnneAdı='$AnneAdi', SeriNo='$SeriNo', Eposta='$Eposta', Telno='$Telno', 
Adres='$Adres', WebAdresi='$WebAdresi', İl='$Il', İlçe='$Ilce', DoğumTarihi='$DogumTarihi', 
DoğumYeri='$DogumYeri', KanGrubu='$KanGrubu', Grubu='$Grubu', Görevi='$Gorevi', Meslek='$Meslek', 
ÇalıştığıYer='$CalistigiYer', ÖğrenimDurumu='$OgrenimDurumu', Cinsiyet='$Cinsiyet', Boy='$Boy', 
Kilo='$Kilo', MedeniHali='$MedeniHali', AskerlikDurumu='$AskerlikDurumu', ÜyeŞifresi='$UyeSifresi', 
ÜyeKayıtTarihi='$UyeKayitTarihi'
WHERE ÜyeID='$UyeID'";
...
{ 
    ...
    <h2> Üye bilgileri düzenlendi! </h2>
    </center>"; 
